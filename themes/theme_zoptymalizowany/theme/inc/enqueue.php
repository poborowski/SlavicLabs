...
if (!function_exists('understrap_scripts')) {
	...
	function understrap_scripts()
	{
		...
		$js_version1 = $theme_version . '.' . filemtime(get_template_directory() . '/js/sliders.js');
		wp_enqueue_script('scripts', get_template_directory_uri() . '/js/sliders.js', array(), $js_version1, true);
